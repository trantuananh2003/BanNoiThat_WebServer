...
namespace BanNoiThat.Infrastructure.SqlServer.Migrations
{
    ...
    [Migration("20250307175932_Create_Order_OrderItems")]
    partial class Create_Order_OrderItems
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BanNoiThat.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("BanNoiThat.Domain.Entities.ProductItem", "ProductItem")
                        .WithOne()
                        .HasForeignKey("BanNoiThat.Domain.Entities.OrderItem", "ProductItem_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
